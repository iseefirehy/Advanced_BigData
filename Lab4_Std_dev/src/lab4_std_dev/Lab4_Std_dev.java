...
public class Lab4_Std_dev {
       public static class StdMap extends Mapper<Object,Text,Text,DoubleWritable>{
           ...
           public static class StdReducer extends Reducer<Text,DoubleWritable,Text,MedianSDCustomWritable>
           {
               ...
               protected void reduce(Text key, Iterable<DoubleWritable> values, Context context) throws IOException, InterruptedException {
                    ...
                    if(count % 2 ==0){
                        result.setMedian((list.get((int)count/2-1) + list.get((int)count/2-2))/2);
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = Job.getInstance(conf, "Lab4_STD");
